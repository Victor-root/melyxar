...
Fait depuis : l'écran de gestion des comptes dans l'administration, et la limite de lectures simultanées, comptée sur les appareils en train de lire.

Reste : la liste des appareils connectés avec révocation individuelle ; le code à quatre chiffres pour les télévisions déjà autorisées ; et la limite d'âge, reportée exprès (voir le README des décisions).
