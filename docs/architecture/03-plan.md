...
- **Retirer une racine ou une médiathèque depuis l'interface.** Ajouter est fait et sans risque ; retirer emporte les fichiers trouvés par la racine, donc la progression et les favoris qui y sont attachés, et laisse des œuvres sans aucun fichier. À décider avant d'être codé : ce qui est effacé, ce qui est gardé, et ce que l'écran annonce avant. Corriger une erreur de frappe se fait déjà en renommant, ce qui ne coûte rien.
