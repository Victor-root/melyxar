...
Reste : le transcodage vidéo logiciel vers H.264 n'a jamais été exercé en vrai (aucun film de test ne l'exige ici), et les sous-titres en images ne sont toujours pas incrustés dans la vidéo : la décision le dit, le moteur ne le fait pas encore.
