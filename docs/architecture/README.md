...
| Identité visuelle | Rouge `#c81e1e` comme couleur de thème du script d'installation et accentuation par défaut de l'interface. Texte posé dessus toujours blanc (contraste 5,7 pour 1 ; en noir seulement 3,7). Variante éclaircie obligatoire en thème sombre | Vérifié, pas supposé. Confirme que l'accentuation est un jeu de variantes, pas une couleur unique. |
