...
| Rien à côté des médias | Melyxar n'écrit jamais dans les dossiers de médias. Tout vit dans ses propres répertoires sur le disque rapide. Lecture des fichiers d'accompagnement existants en option, désactivée par défaut ; écriture non prévue | Les disques de médias peuvent rester en lecture seule, et la sauvegarde du serveur suffit à tout restaurer. |
