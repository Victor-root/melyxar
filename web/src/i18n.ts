...
const en: Dictionary = {
  ...
  "settings.avatar_why": "Shown beside your name at the top of every page and on the sign in screen. Any photo will do: it is turned the right way up and cut square around its middle.",
...
const fr: Dictionary = {
  ...
  "settings.avatar_why": "Affichée à côté de votre nom en haut de chaque page et sur l'écran de connexion. N'importe quelle photo fait l'affaire : elle est remise à l'endroit et coupée au carré en son centre.",
